...
function additionalTags(tags = '', tags2 = '', artistName = '', artistName2 = ''){
    ...
    tags += `
        ...
        ${artistName} type beat 2018 with hook,
        ${artistName} type beat 2018 with hook free,
        ...
        ${artistName} type instrumental 2018,
        ${artistName} type instrumental 2018 with hook,
        ${artistName} type instrumental 2018 with hook free,
        `
        ...
        ${artistName2} type beat 2018 with hook,
        ${artistName2} type beat 2018 with hook free,
        ...
        ${artistName2} type instrumental 2018,
        ${artistName2} type instrumental 2018 with hook,
        ${artistName2} type instrumental 2018 with hook free,
...
function tag(){
    ...
    var album2 = document.getElementById("album2").value;
    var mood = document.getElementById("mood").value;
    var mood2 = document.getElementById("mood2").value;
...
function videoName(){
    ...
    var genre = document.getElementById("genre").value;
    var title = `[FREE] ${descriptiveItem} ${descriptiveItem2} ${artistName} x ${artistName2} Type Beat - "${songName}" | ${genre} Beat/Instrumental 2020`;
